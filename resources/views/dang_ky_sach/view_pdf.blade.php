...
<head>
	...
	<title>Danh sách sinh viên đã đăng ký sách {{$array_dang_ky_sach[0]->ten_sach}} lớp {{$array_dang_ky_sach[0]->ten_lop}}</title>
	<style>
		.page-break {
...
<body>
	<center><h3>Danh sách sinh viên đã đăng ký sách {{$array_dang_ky_sach[0]->ten_sach}} lớp {{$array_dang_ky_sach[0]->ten_lop}}</h3>
