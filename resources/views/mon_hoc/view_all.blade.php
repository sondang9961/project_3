		...
		<div class="content">
			<div class="toolbar">
				<form>
					...
					<input type="button" class="btn btn-danger btn-round btn-sm btn-outline" value="Xuất file pdf" onclick="location.href='{{ route('mon_hoc.export_pdf') }}'" style="margin-left: 5px">
				</form>
			</div>
